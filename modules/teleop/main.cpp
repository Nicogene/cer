...
typedef Publisher<visualization_msgs_MarkerArray> MarkerArrayPort;
/**********************************************************/
...
public:
    ...
    /**********************************************************/
    void reachingHandler(const bool b, const Vector& pos, const Vector& rpy)
    {
        if (b)
        {
            if (s0 == idle)
            ...
            else
            {
                ...
                az[2]     = 1.0;
                ax[3]     = drpy[2];
                ay[3]     = drpy[1]*((arm_type=="right")?-1.0:+1.0);
                az[3]     = drpy[0]*((arm_type=="right")?-1.0:+1.0);
